...
export const criteriaGestores: Criterion[] = [
  ...
  { id: "exec7", name: "Geração de Conhecimento", description: "Compartilha aprendizados e propõe melhorias para o processo", category: "Execução e Processos", weight: 6 },
...
export const criteriaOperacionais: Criterion[] = [
  ...
  { id: "result4", name: "Busca de Orientação", description: "Esclarece dúvidas e valida o entendimento da demanda", category: "Resultado/Entrega", weight: 8 },
