...
export const criteriaGestores: Criterion[] = [
  ...
  { id: "exec2", name: "Execução", description: "Cumpre prazos e o planejado", category: "Execução e Processos", weight: 5 },
  { id: "exec3", name: "Controle", description: "Acompanha, cobra e ajusta as atividades", category: "Execução e Processos", weight: 5 },
  { id: "exec4", name: "Processos", description: "Segue e garante os padrões definidos", category: "Execução e Processos", weight: 5 },
  { id: "exec5", name: "Segurança (EPI)", description: "Cumpre e cobra o uso correto de EPIs", category: "Execução e Processos", weight: 3 },
  { id: "exec6", name: "Capricho", description: "Atua com atenção aos detalhes e qualidade, mantém ambiente limpo e organizado", category: "Execução e Processos", weight: 3 },
  { id: "exec7", name: "Geração de Conhecimento", description: "Compartilha aprendizados e propõe melhorias para o processo", category: "Execução e Processos", weight: 4 },
...
export const criteriaOperacionais: Criterion[] = [
  ...
  { id: "result1", name: "Produtividade", description: "Entrega no prazo ou acima do esperado", category: "Resultado/Entrega", weight: 10 },
  { id: "result2", name: "Comprometimento", description: "Cumpre o que foi combinado e assume responsabilidades", category: "Resultado/Entrega", weight: 8 },
  { id: "result3", name: "Cuidado com equipamentos", description: "Zela por máquinas e ferramentas", category: "Resultado/Entrega", weight: 7 },
  { id: "result4", name: "Busca de Orientação", description: "Esclarece dúvidas e valida o entendimento da demanda", category: "Resultado/Entrega", weight: 5 },
